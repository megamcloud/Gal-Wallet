...
/**
 * Issue a currency on the GAL blockchain
 * <p>
 * A currency is the basic block of the GAL Monetary System it can be exchanged with GAL, transferred between accounts,
 ...
 * <li>minReservePerUnitNQT - the minimum GAL value per unit to allow the currency to become active
 * For {@link nxt.CurrencyType#RESERVABLE} currency
 ...
 * When a {@link nxt.CurrencyType#RESERVABLE} becomes active, in case it is {@link nxt.CurrencyType#CLAIMABLE} the GAL used for
 * reserving the currency are locked until they are claimed back.
 * When a {@link nxt.CurrencyType#RESERVABLE} becomes active, in case it is non {@link nxt.CurrencyType#CLAIMABLE} the GAL used for
