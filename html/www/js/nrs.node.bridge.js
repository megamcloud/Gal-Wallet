const options = {
    url: "http://localhost:6876", // URL of GAL remote node
...
exports.load = function(callback) {
    ...
    require("jsdom").env("", function(err, window) {
        try {
            ...
            // the GAL client wasn't designed with modularity in mind therefore we need
            ...
            // Now load some GAL specific libraries into the global scope
            ...
            // however the GAL client relies on a global browser scope which defines the NRS object
