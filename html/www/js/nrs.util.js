...
var NRS = (function (NRS, $, undefined) {
    ...
    NRS.isRsAccount = function(account) {
        return NRS.isRsAccountImpl(account, NRS.constants.ACCOUNT_RS_MATCH ? NRS.constants.ACCOUNT_RS_MATCH : NRS.getRsAccountRegex("GAL"));
    };
    ...
    NRS.getAccountMask = function(c) {
        switch(c) {
            ...
            default:
                return NRS.constants.ACCOUNT_MASK_PREFIX ? NRS.constants.ACCOUNT_MASK_PREFIX : "GAL-";
        }
    };

    NRS.printPaperWallet = function(passphrase) {
        var $pageHeader = $("<h2 data-i18n='nxt_ardor_paper_wallet'>GAL and Ardor Paper Wallet</h2>");
