...
QUnit.test("getAccountLink", function (assert) {
    ...
    assert.equal(NRS.getAccountLink({ entity: 5873880488492319831 }, "entity"), "<a href='#' data-user='GAL-XKA2-7VJU-VZSY-7R335' class='show_account_modal_action user-info'>/</a>", "numeric");
    assert.equal(NRS.getAccountLink({ entityRS: "GAL-XK4R-7VJU-6EQG-7R335" }, "entity"), "<a href='#' data-user='GAL-XK4R-7VJU-6EQG-7R335' class='show_account_modal_action user-info'>GAL-XK4R-7VJU-6EQG-7R335</a>", "RS");
    assert.equal(NRS.getAccountLink({ entity: 5873880488492319831, entityRS: "GAL-XK4R-7VJU-6EQG-7R335" }, "entity"), "<a href='#' data-user='GAL-XK4R-7VJU-6EQG-7R335' class='show_account_modal_action user-info'>GAL-XK4R-7VJU-6EQG-7R335</a>", "numeric.and.RS");
    NRS.contacts = { "GAL-XK4R-7VJU-6EQG-7R335": { name: "foo" }};
    assert.equal(NRS.getAccountLink({ entityRS: "GAL-XK4R-7VJU-6EQG-7R335" }, "entity"), "<a href='#' data-user='GAL-XK4R-7VJU-6EQG-7R335' class='show_account_modal_action user-info'>foo</a>", "contact");
    NRS.accountRS = "GAL-XK4R-7VJU-6EQG-7R335";
    assert.equal(NRS.getAccountLink({ entityRS: "GAL-XK4R-7VJU-6EQG-7R335" }, "entity"), "<a href='#' data-user='GAL-XK4R-7VJU-6EQG-7R335' class='show_account_modal_action user-info'>You</a>", "you");
    assert.equal(NRS.getAccountLink({ entityRS: "GAL-XK4R-7VJU-6EQG-7R335" }, "entity", "GAL-XK4R-7VJU-6EQG-7R335", "account"), "<a href='#' data-user='GAL-XK4R-7VJU-6EQG-7R335' class='show_account_modal_action user-info'>Account</a>", "force.account.name");
    assert.equal(NRS.getAccountLink({ entityRS: "GAL-XK4R-7VJU-6EQG-7R335" }, "entity", undefined, undefined, true), "<a href='#' data-user='GAL-XK4R-7VJU-6EQG-7R335' class='show_account_modal_action user-info'>GAL-XK4R-7VJU-6EQG-7R335</a>", "maintain.rs.format");
    assert.equal(NRS.getAccountLink({ entityRS: "GAL-XK4R-7VJU-6EQG-7R335" }, "entity", undefined, undefined, undefined, "btn btn-xs"), "<a href='#' data-user='GAL-XK4R-7VJU-6EQG-7R335' class='show_account_modal_action user-info btn btn-xs'>You</a>", "add.class");
    NRS.contacts = null;
    NRS.accountRS = null;
    NRS.constants.GENESIS = 1739068987193023818;
    NRS.constants.GENESIS_RS = "GAL-MR8N-2YLS-3MEQ-3CMAJ";
    assert.equal(NRS.getAccountLink({ entityRS: NRS.constants.GENESIS_RS }, "entity"), "<a href='#' data-user='GAL-MR8N-2YLS-3MEQ-3CMAJ' class='show_account_modal_action user-info'>Genesis</a>", "genesis");
});
...
QUnit.test("accountMatching", function (assert) {
    var regex = NRS.getRsAccountRegex("GAL");
    assert.equal(NRS.isRsAccountImpl("GAL-XK4R-7VJU-6EQG-7R335", regex), true, "valid.account");
    assert.equal(NRS.isRsAccountImpl("Nxt-xk4r-7VJU-6EQG-7R335", regex), true, "not.case.sensitive");
    assert.equal(NRS.isRsAccountImpl("GAL-XK4R-7VJU-6EQG-7R336", regex), true, "nor.rs.valid.still.valid");
    assert.equal(NRS.isRsAccountImpl("5873880488492319831", regex), false, "numeric.no.match");
    assert.equal(NRS.isRsAccountImpl("GAL-____-____-____-_____", regex), true, "underscore_mask_again");
    regex = NRS.getNumericAccountRegex();
    assert.equal(NRS.isNumericAccountImpl("GAL-XK4R-7VJU-6EQG-7R335", regex), false, "non.numeric.no.match");
